...
#SCOUT questions
scout_q1 = Question("Dekryptera ordet med SCOUT: \nTu Cc Cc Co Ss", "uggla", "Byt ut paren mot bokstaven där koordinaterna möts.", "", "", "scout", False, 8, 2)
scout_q2 = Question("Dekryptera ordet med SCOUT: \nTt Us Co Ss", "ödla", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 9, 2)
scout_q3 = Question("Dekryptera ordet med SCOUT: \nSu Cu Ts Ou Uc Us Ts Uo Uu", "president", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 10, 2)
scout_q4 = Question("Dekryptera ordet med SCOUT: \nOu Pu Tt So Ts", "spöke", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 11, 2)
scout_q5 = Question("Dekryptera ordet med SCOUT: \nTs Co Ts Sc Ss Uo Uu", "elefant", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 12, 2)
scout_q6 = Question("Dekryptera ordet med SCOUT: \nCs Ct Uu Ts", "byte", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 13, 2)
scout_q7 = Question("Dekryptera ordet med SCOUT: \nUo Ut Uu St Ts Cu So", "nätverk", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 14, 2)
scout_q8 = Question("Dekryptera ordet med SCOUT: \nCs Uc Co", "bil", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 15, 2)
scout_q9 = Question("Dekryptera ordet med SCOUT: \nUs Ts Os Uc Oo Ss Co", "decimal", "Byt ut paren mot bokstaven där de möts.", "", "", "scout", False, 16, 2)
...
def change_button_color():
    if event == "-DIFF1-":
        ...
        window["-DIFF4-"].update(button_color="#150B3F")
    elif event == "-DIFF2-":
        ...
        window["-DIFF2-"].update(button_color="#150B3F")
        window["-DIFF3-"].update(button_color="#150B3F")
        window["-DIFF4-"].update(button_color="#150BFF")
